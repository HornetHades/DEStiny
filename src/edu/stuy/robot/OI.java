...
import static edu.stuy.robot.RobotMap.TEST_GAMEPAD;
...
public class OI {
    ...
    public OI() {
        ...
        testGamepad = new Gamepad(TEST_GAMEPAD);

        driverGamepad.getStartButton().whenPressed(
                new EnableAutoGearShiftCommand());
        driverGamepad.getSelectButton().whenPressed(
                new DisableAutoGearShiftCommand());
        ...
        operatorGamepad.getRightTrigger().whileHeld(
                new AcquirerAcquireCommand());
        operatorGamepad.getRightBumper().whileHeld(
                new AcquirerDeacquireCommand());
        ...
        operatorGamepad.getRightAnalogButton().whenPressed(
                new DropDownMoveToAngleCommand(35));
    }
}
